...
var _user$project$Shared$initialModel = {showNavigation: true};
var _user$project$Shared$Model = function (a) {
	return {showNavigation: a};
};
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Talks, meetups, coding sessions, ...'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Content$aboutView,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$ToggleNavigation = function (a) {
	...
	return A2(
		...
		},
		{
			...
			_0: A3(
				...
				function (c) {
					return _user$project$Main$ToggleNavigation(!c);
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$View$about(model),
					_1: {
						ctor: '::',
